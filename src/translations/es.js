export const es = {
  ...
  experience: {
    ...
    openSource: {
      ...
      achievements: [
        '5+ repositorios públicos activos con demos en producción',
        'SkyCheck, Color Generator y Hypr-Dot con usuarios reales',
      ]
    }
  },
  ...
  projects: {
    ...
    h3nColors: {
      ...
      description: 'Diseña paletas con validación de contraste WCAG integrada — accesibilidad desde el primer clic',
    ...
    "skyCheck": {
      "title": "SkyCheck",
      "description": "Información meteorológica detallada con UX limpia y geolocalización automática",
    ...
    zenShell: {
      title: 'ZenShell Bot',
      description: 'Automatización y gestión de comunidades Discord desde un panel web',

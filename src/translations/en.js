export const en = {
  ...
  hero: {
    ...
    tagline: 'I build backends that solve real problems — from REST APIs with authentication to Discord bots with control panels. I work on Linux, think in systems, write in Python.'
  },
